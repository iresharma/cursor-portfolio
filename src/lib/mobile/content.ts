...
export const CHIPS: Chip[] = [
  ...
  },
  {
    ...
    reply:
      "Basketball, 3D printing, IoT, photography, hip-hop — extras/hobbies.md. Games got their own file for PSN and Valorant, once I am brave enough to link the accounts.",
  },
  {
    id: "writing",
    label: "Writing",
